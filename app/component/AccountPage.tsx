  ...
  return (
    <div className="app-shell">
      ...
      <main className="account-content">
        ...
        {kind === "saved" && <><PageIntro eyebrow="YOUR SPACE" title="Saved rooms" description="Rooms you bookmarked for a later listen." /><div className="account-room-grid">{rooms.slice(0, 2).map((room) => <RoomCard key={room.id} room={room} />)}</div></>}
